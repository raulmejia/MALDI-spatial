...
## And applies a normalizadion average pixel - proportion of compounds.
########
#####
...
# Number of compounds per phenotype
list_subtables_phenotype_columns_included <- split(table_with_phenotype_column_clean , table_with_phenotype_column_clean$phenotype )
